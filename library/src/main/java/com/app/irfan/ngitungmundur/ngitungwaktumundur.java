package com.app.irfan.ngitungmundur;
...
public class ngitungwaktumundur extends View
{
    ...
    public ngitungwaktumundur(Context context, AttributeSet attrs, int defStyleAttr)
    {
        super(context, attrs, defStyleAttr);
        initialize();
    }

    public ngitungwaktumundur(Context context, AttributeSet attrs)
    {
        this(context, attrs, 0);
    }

    public ngitungwaktumundur(Context context)
    {
        this(context, null);
    }
