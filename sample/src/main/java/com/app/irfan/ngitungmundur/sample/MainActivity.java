package com.app.irfan.ngitungmundur.sample;
...
import com.app.irfan.ngitungmundur.ngitungwaktumundur;


public class MainActivity extends ActionBarActivity implements ngitungwaktumundur.CircleTimerListener
{

    private static final String TAG = MainActivity.class.getSimpleName();

    private ngitungwaktumundur mTimer;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mTimer = (ngitungwaktumundur) findViewById(R.id.ctv);
